package com.company.bps.web;

import com.company.bps.web.screens.sampler.SamplerScreen;
...
public class ExtMainScreen extends MainScreen {
    ...
    public ExtMainScreen() {
        ...
        addAfterShowListener(this::openSamplerWindow);
    }
    ...
    private void openSamplerWindow(AfterShowEvent event) {
        screenBuilders.screen(this)
                .withScreenClass(SamplerScreen.class)
                .build()
                .show();
    }
}