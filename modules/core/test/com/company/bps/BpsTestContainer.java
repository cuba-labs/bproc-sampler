...
public class BpsTestContainer extends TestContainer {

    public BpsTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/bps/app.properties",
    ...
    public static class Common extends BpsTestContainer {

        public static final BpsTestContainer.Common INSTANCE = new BpsTestContainer.Common();
